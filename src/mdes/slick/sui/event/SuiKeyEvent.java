 ...
 * @since b.0.2
 */
public class SuiKeyEvent extends SuiEvent {
    ...
    /** 
     * Creates a new SuiKeyEvent with the specified params.
     *
     * @param source the source container for this event
     * @param id the event id, either KEY_PRESSED or KEY_RELEASED
     * @param key the key code
     * @param chr the key char
     */
    public SuiKeyEvent(SuiContainer source, int id, int key, char chr) {
        super(source, id);
        this.key = key;
        this.chr = chr;
    }
     ...
     * 
     * @returns the key code, conforming to the Input key constants
     */
