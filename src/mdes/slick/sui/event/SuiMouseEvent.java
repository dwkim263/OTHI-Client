 ...
 * @since b.0.2
 */
public class SuiMouseEvent extends SuiEvent {
     ...
     */
    public SuiMouseEvent(SuiContainer source, int id, int button, 
     ...
     * @param absy the absolute y position to the game container 
     */
    public SuiMouseEvent(SuiContainer source, int id, int x, int y, 
                        int absx, int absy) {
     ...
     *
     * @returns the old x position, local to the parent container
     */
    public int getOldX() {
        return ox;
    }
     ...
     *
     * @returns the old y position, local to the parent container
     */
    public int getOldY() {
        return oy;
    }
     ...
     *
     * @returns the x position in the container's local space
     */
    public int getX() {
        return x;
    }
     ...
     *
     * @returns the y position in the container's local space
     */
    public int getY() {
        return y;
    }
    ...
    /**
     * Gets the button that is down, or NOBUTTON if there is
     * no mouse button down.
     *
     * @returns the button index (starting at 0, 
