 ...
 * @since b.0.2
 */
public class SuiControllerEvent extends SuiEvent {
     ...
     */
    public SuiControllerEvent(SuiContainer source, int id, int controller, int button) {
        super(source, id);
        this.button = button;
     ...
     * The button for this event, conforming to the button constants.
     *
     * @returns the button that was pressed or released
     */
